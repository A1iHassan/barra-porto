  ...
  return (
    <div className="icon">
      <svg
        ...
        data-name="Layer 1"
        viewBox="0 0 256 256"
        id="adobe-animate-file"
      >
        <g data-name="Layer 2">
          <g data-name="Video Audio Surface">
            <rect
              width="240"
              height="232"
              x="8"
